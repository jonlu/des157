...
float randy = 25.0; //size of hexagon
float w = 0;
int fade = 255;
...
void draw() {
  ...
  for (int i = 0; i < xwidth; i+=50) {
    for (int j = 0; j < xwidth; j+=90) {
  ...
  for (int i = 25; i < xwidth; i+=50) {
    for (int j = 45; j < xwidth; j+=90) {
